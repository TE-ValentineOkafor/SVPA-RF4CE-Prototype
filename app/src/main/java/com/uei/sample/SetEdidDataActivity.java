                ...
                try {
                    ...
                    if (inputFile.length() >= 0) {
                        ...
                        if(_setup != null && byteRead > 0){
                            ...
                            Log.d(QuicksetSampleActivity.LOGTAG, "Set EDID data status: " + ResultCode.getString(status));
                            finish();
                       }
                    } else {
                    ...
                    Log.d(QuicksetSampleActivity.LOGTAG, "setEdidData exception: " + ex.toString());
                }
            }
        });
            ...
            switch(requestCode) {
                case DIALOG_KEY:
                    if(data.hasExtra(FilePickerActivity.EXTRA_FILE_PATH)) {
                        ...
                        Log.d(QuicksetSampleActivity.LOGTAG, "edid data file: " + fileName);
                    }
            }
        }
    }
